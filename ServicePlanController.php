...
use App\Models\ServicePlanToIndustry;
...
use App\Jobs\StatusUpdateMail;
    ...
    class ServicePlanController extends Controller
    {
        ...
        public function details(Request $request){
            ...
            $data = ServicePlan::where('plan_id', $plan_id)->first();
            if(!empty($data)){
        ...
        public function update(Request $request){
            ...
            $data = ServicePlan::where('plan_id', $plan_id)->update([
                'plan_name'=>$plan_name, 
                'plan_desc'=>$plan_desc, 
                'plan_amount'=>$plan_amount, 
                'plan_duration'=>$plan_duration,
        ...
        public function changeStatus(Request $request)
        {
            ...
            $plan_id = $request->plan_id;
            $sub_data = ServicePlan::where('plan_id', $plan_id)->first();
           
            if($sub_data->status =='1'){
                $data = ServicePlan::where('plan_id', $plan_id)->update(['status'=> '0']);
                $status = 'Deactivated';
                

            }else{
                $data = ServicePlan::where('plan_id', $plan_id)->update(['status'=> '1']);
                $status = 'Activated';
            }
