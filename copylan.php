...
class LanguageController extends Controller
{
   ...
   public function trans_edit_key_value(Request $request){
        ...
        $all_key_group_query =  TranslationKey::selectRaw("distinct(section_id) as section_id ")
        ->where('source', $lang_key_id);
        
        if( $section_key){
        $all_key_group_query->where('section_id', $section_key);
        }

        $all_key_group = $all_key_group_query->orderBy('section_id', 'ASC')->get();
